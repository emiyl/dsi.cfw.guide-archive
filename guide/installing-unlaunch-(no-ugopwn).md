---
title: Installing Unlaunch (No ugopwn)
layout: single
sidebar:
  nav: "no-ugopwn"
---

This guide requires an existing DSi exploit.
{: .notice--info}
...
[Installing HiyaCFW](/guide/installing-hiyacfw-(no-ugopwn)/){: .btn .btn--light-outline}
